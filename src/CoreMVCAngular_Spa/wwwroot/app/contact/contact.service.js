        ...
        execute: function() {
            ContactService = (function () {
                function ContactService(_http) {
                    ...
                    this._saveUrl = 'http://localhost:8081/api/Contact/PostContact';
                    this._updateUrl = 'http://localhost:8081/api/Contact/PutContact';
                    this._getUrl = 'http://localhost:8081/api/Contact/GetContact';
                    this._getByIdUrl = 'http://localhost:8081/api/Contact/GetContactByID';
                    this._deleteByIdUrl = 'http://localhost:8081/api/Contact/DeleteContactByID';
                }
                //Get
